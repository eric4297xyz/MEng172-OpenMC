# FILE: reactor_Depleted_Eigenvalue_4.py
# Iteration4: Eigenvalue depletion simulation with spent LWR fuel
...
from fuel_blanket_4 import build_trufuelsphere_nobox
...
# SHORT TIME STEPS for accurate depletion tracking
# 10-day steps for 30 days total
days_per_step = 10.0
num_steps = 3  # 3 steps × 10 days = 30 days total
...
print("="*70)
print("ITERATION 4: EIGENVALUE DEPLETION - MEDIUM RESOLUTION")
print("="*70)
...
print("  - Medium statistics: 1M particles per step (BALANCED)")
print("  - Short time steps: 10 days for accurate tracking")
print(f"  - Total simulation time: {total_days:.0f} days")
...
output_dir = "results/iteration4_eigenvalue_highres"
...
print("")
print("MEDIUM RESOLUTION - Expected runtime: 30-60 minutes")
...
print(f"\n{'='*70}")
print("ITERATION 4 EIGENVALUE DEPLETION COMPLETE")
print(f"{'='*70}")
...
print("")
print("Expected results for subcritical spent fuel over 30 days:")
print("  - k-eff: ~0.4-0.6 (subcritical)")
print("  - Modest U-235 and Pu-239 depletion from fission")
print("  - Small amount of Pu-239 production from U-238 capture")
print("  - Gradual buildup of fission products")
print("  - TRU transmutation (minimal net change over 30 days)")
print("")
print("To analyze results, run:")
print("  python results_depleted_eigenvalue_4.py")
print(f"{'='*70}")
