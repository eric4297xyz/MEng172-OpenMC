#!/usr/bin/env python3
"""
Fusion-Fission Hybrid Reactor Simulation with Fixed-Source Depletion

This script correctly implements fixed-source depletion for a D-D fusion-driven
...
- Spherical geometry with Na coolant
...
Author: Iteration 6 - Corrected Implementation
Date: February 2026
"""
...
# Output directory (within current iteration directory)
output_dir = os.path.join(SCRIPT_DIR, "results_manual_depletion")
os.makedirs(output_dir, exist_ok=True)

print("="*70)
print("D-D FUSION-FISSION HYBRID REACTOR SIMULATION")
print("="*70)
...
print("\n" + "="*70)
print("STARTING FIXED-SOURCE DEPLETION SIMULATION")
print("="*70)
...
with open(os.path.join(output_dir, 'depletion_summary.txt'), 'w') as f:
    f.write("D-D FUSION-FISSION HYBRID REACTOR - DEPLETION RESULTS\n")
    f.write("="*70 + "\n\n")
