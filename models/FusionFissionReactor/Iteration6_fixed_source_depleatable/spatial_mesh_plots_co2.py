"""
FILE: spatial_mesh_plots_co2.py
Create 2D spatial plots from mesh tallies in CO2 coolant depletion results
...
def main():
    ...
    """
    print("="*70)
    print("SPATIAL MESH PLOTS FOR FUSION-FISSION HYBRID REACTOR - CO2 COOLANT")
    print("="*70)
    print(f"\\nResults: {RESULTS_DIR}")
    ...
    print("\\n" + "="*70)
    print("SPATIAL PLOTTING COMPLETE - CO2 COOLANT")
    print("="*70)
