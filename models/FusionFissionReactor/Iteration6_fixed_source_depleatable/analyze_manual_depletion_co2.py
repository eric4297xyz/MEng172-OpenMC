#!/usr/bin/env python3
"""
Comprehensive Analysis of Manual Depletion Results - CO2 COOLANT STUDY
...
RESULTS_DIR = os.path.join(SCRIPT_DIR, "results_manual_depletion", "co2_coolant_study")
...
def create_detailed_summary():
    ...
    with open(OUTPUT_FILE, 'w') as f:
        f.write("="*70 + "\n")
        f.write("ITERATION 6: CO2 COOLANT STUDY RESULTS\n")
        f.write("Fusion-Fission Hybrid Reactor with CO₂ Moderator/Coolant\n")
        f.write("="*70 + "\n\n")
...
def main():
    """Main execution."""
    print("="*70)
    print("MANUAL DEPLETION ANALYSIS - CO2 COOLANT STUDY")
    print("="*70)
    print()
